import { ReleasePlanMilestoneStore, ReleasePlanMilestoneStrategyStore, ReleasePlanStore, ReleasePlanTemplateStore, } from '../types/index.js';
...
export const createStores = (config, db) => {
    ...
    return {
        ...
        clientMetricsStoreV2: new ClientMetricsStoreV2(db, eventBus, getLogger, config.flagResolver),
        ...
        clientFeatureToggleStore: new FeatureToggleClientStore(db, eventBus, config),
        environmentStore: new EnvironmentStore(db, eventBus, config),
        featureTagStore: new FeatureTagStore(db, eventBus, getLogger),
        featureEnvironmentStore: new FeatureEnvironmentStore(db, eventBus, config),
        ...
        uniqueConnectionReadModel: new UniqueConnectionReadModel(new UniqueConnectionStore(db)),
        ...
        releasePlanMilestoneStrategyStore: new ReleasePlanMilestoneStrategyStore(db, config),
