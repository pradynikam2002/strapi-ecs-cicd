...
import { responseTimeMetrics, corsOriginMiddleware, } from './middleware/index.js';
...
import noAuthentication, { noApiToken, } from './middleware/no-authentication.js';
...
export default async function getApp(config, stores, services, unleashSession, db) {
    const app = express();
    ...
    app.use(`${baseUriPath}/api/frontend*`, corsOriginMiddleware(services, config));
    app.options(`${baseUriPath}/api/streaming*`, corsOriginMiddleware(services, config));
