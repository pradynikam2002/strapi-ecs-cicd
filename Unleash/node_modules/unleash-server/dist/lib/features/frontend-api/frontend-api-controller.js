...
import { createRequestSchema, createResponseSchema, emptyResponse, frontendApiFeaturesSchema, getStandardResponses, } from '../../openapi/index.js';
...
export default class FrontendAPIController extends Controller {
        ...
        this.route({
            ...
            middleware: [
                this.services.openApiService.validPath({
                    ...
                    requestBody: createRequestSchema('frontendApiFeaturesPostSchema'),
                    responses: {
                        200: createResponseSchema('frontendApiFeaturesSchema'),
                        ...getStandardResponses(401, 404),
                    },
    ...
    async registerFrontendApiMetrics(req, res) {
        ...
        await this.services.frontendApiService.registerFrontendApiMetrics(req.user, req.body, req.ip, req.headers['unleash-sdk']);
        res.sendStatus(200);
    }
