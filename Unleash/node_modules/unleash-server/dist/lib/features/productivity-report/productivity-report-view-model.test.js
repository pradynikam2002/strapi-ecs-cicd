import { productivityReportViewModel, } from './productivity-report-view-model.js';
const mockData = {
...
describe('productivityReportViewModel', () => {
    ...
    describe('technicalDebtTrendMessage', () => {
        it('returns correct trend message when technica debt decreased', () => {
            ...
            expect(viewModel.technicalDebtTrendMessage()).toMatchInlineSnapshot(`"<span style='color: #68a611'>&#9660;</span> 10% less than previous month"`);
        });
        it('returns correct trend message when technical debt increased', () => {
            ...
            expect(viewModel.technicalDebtTrendMessage()).toMatchInlineSnapshot(`"<span style='color: #d93644'>&#9650;</span> 10% more than previous month"`);
        });
        it('returns correct message when technical debt is the same', () => {
            ...
            expect(viewModel.technicalDebtTrendMessage()).toMatchInlineSnapshot(`"Same as last month"`);
        });
    });
    describe('flagsCreatedTrendMessage', () => {
        it('returns correct trend message for flagsCreated increase', () => {
            ...
            expect(viewModel.flagsCreatedTrendMessage()).toMatchInlineSnapshot(`"<span style='color: #68a611'>&#9650;</span> 2 more than previous month"`);
        });
    });
    describe('productionUpdatedTrendMessage', () => {
        it('returns correct trend message for productionUpdates decrease', () => {
            ...
            expect(viewModel.productionUpdatedTrendMessage()).toMatchInlineSnapshot(`"<span style='color: #d93644'>&#9660;</span> 3 less than previous month"`);
        });
    });
