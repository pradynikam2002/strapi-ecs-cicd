import { mapFeaturesForClient, mapSegmentsForClient, offlineUnleashClient, } from './offline-unleash-client.js';
...
export const offlineUnleashClientNode = async ({ features, context, logError, segments, }) => {
...
describe('offline client', () => {
    ...
    it(`returns '${playgroundStrategyEvaluation.unknownResult}' if it can't evaluate a feature`, async () => {
        ...
        const result = client.isEnabled(name, context);
        result.strategies.forEach((strategy) => expect(strategy.result.enabled).toEqual(playgroundStrategyEvaluation.unknownResult));
