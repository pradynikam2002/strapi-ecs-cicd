...
test('Return basic insights', async () => {
    const { projectInsightsService, projectStatsStore, featureToggleStore, projectStore, } = createFakeProjectInsightsService();
...
//# sourceMappingURL=project-insights-service.test.js.map