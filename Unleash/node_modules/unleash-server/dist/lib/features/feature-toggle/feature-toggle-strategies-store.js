...
import { ensureStringValue, generateImageUrl, mapValues, } from '../../util/index.js';
...
const defaultParameters = (params, stickiness) => {
...
const parametersWithDefaults = (params, stickiness) => {
