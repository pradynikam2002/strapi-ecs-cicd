...
describe('Strategy limits', () => {
    test('Should not allow to exceed strategy limit', async () => {
        ...
        await expect(addStrategy()).rejects.toThrowError("Failed to create strategy. You can't create more than the established limit of 3");
    });
    test('Should not allow to exceed constraints limit', async () => {
        ...
        ])).rejects.toThrowError("Failed to create constraints. You can't create more than the established limit of 1");
    });
    test('Should not throw limit exceeded errors if the new number of constraints is less than or equal to the previous number', async () => {
        ...
        await expect(async () => updateStrategy([...constraints, ...constraints])).rejects.errorWithMessage(new ExceedsLimitError('constraints', LIMIT));
    });
    test('Should not allow to exceed constraint values limit', async () => {
        ...
        ])).rejects.toThrowError("Failed to create constraint values for userId. You can't create more than the established limit of 3");
    });
    test('Should not throw limit exceeded errors for constraint values if the new values are less than or equal to the old values AND there have been no other constraint updates (re-ordering or deleting)', async () => {
        ...
        await expect(async () => updateStrategy(initialConstraintValueCount + 1)).rejects.errorWithMessage(new ExceedsLimitError('constraint values for appName', LIMIT));
    });
});
