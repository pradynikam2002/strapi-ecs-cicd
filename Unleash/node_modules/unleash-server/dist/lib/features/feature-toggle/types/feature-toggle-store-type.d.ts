import type { FeatureToggle, FeatureToggleDTO, IFeatureToggleQuery, IFeatureTypeCount } from '../../../types/model.js';
...
export interface IFeatureToggleStore extends Store<FeatureToggle, string> {
    ...
    getFeatureToggleList(featureQuery?: IFeatureToggleQuery, userId?: number, archived?: boolean): Promise<FeatureToggle[]>;
...
//# sourceMappingURL=feature-toggle-store-type.d.ts.map