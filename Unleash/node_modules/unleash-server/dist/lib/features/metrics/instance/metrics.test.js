...
describe('bulk metrics', () => {
    test('should separate frontend applications and backend applications', async () => {
        ...
        const app = await services.clientInstanceService.getApplication('application-name');
    ...
    test('should respect project from token', async () => {
        ...
        await request
            ...
            .expect(202);
        await services.clientInstanceService.bulkAdd();
        const app = await services.clientInstanceService.getApplication('application-name-token');
        expect(app).toMatchObject({
            appName: 'application-name-token',
            instances: [
                {
        ...
        const applications = await stores.clientApplicationsStore.getApplications({
            limit: 10,
            offset: 0,
            sortBy: 'name',
            sortOrder: 'asc',
