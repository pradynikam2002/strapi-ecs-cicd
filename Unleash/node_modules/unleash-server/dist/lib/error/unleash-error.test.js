...
import BadDataError, { fromOpenApiValidationError, fromOpenApiValidationErrors, } from './bad-data-error.js';
...
describe('OpenAPI error conversion', () => {
    ...
    it('Handles multiple errors', () => {
        ...
        const serializedUnleashError = fromOpenApiValidationErrors({ body: { newprop: 7 }, query: {} }, errors).toJSON();
    ...
    it('Handles any data, not only requests', () => {
        ...
        const serializedUnleashError = fromOpenApiValidationErrors({ newprop: 7 }, errors).toJSON();
        expect(serializedUnleashError).toMatchObject({
            name: 'BadDataError',
            message: expect.stringContaining('`details`'),
            details: [
    ...
    it('Handles invalid data gracefully', () => {
        ...
        const serializedUnleashError = fromOpenApiValidationErrors({}, errors).toJSON();
        expect(serializedUnleashError).toMatchObject({
            name: 'BadDataError',
            message: expect.stringContaining('`details`'),
            details: [
