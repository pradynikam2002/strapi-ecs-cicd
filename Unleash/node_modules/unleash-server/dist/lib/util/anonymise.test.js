...
describe('anonymiseKeys', () => {
    test.each([
        ...
        [1, 2, 3],
        { test: 'test' },
    ])('A parameter without keys (non-object, non-array) should return the same value', (obj) => expect(anonymiseKeys(obj, [])).toStrictEqual(obj));
...
//# sourceMappingURL=anonymise.test.js.map