...
const flags = {
    ...
    maintenanceMode: parseEnvVarBoolean(process.env.UNLEASH_EXPERIMENTAL_MAINTENANCE_MODE, false),
    messageBanner: {
        name: 'message-banner',
    ...
    originMiddlewareRequestLogging: parseEnvVarBoolean(process.env.UNLEASH_ORIGIN_MIDDLEWARE_REQUEST_LOGGING, false),
    webhookDomainLogging: parseEnvVarBoolean(process.env.UNLEASH_EXPERIMENT_WEBHOOK_DOMAIN_LOGGING, false),
    releasePlans: parseEnvVarBoolean(process.env.UNLEASH_EXPERIMENTAL_RELEASE_PLANS, false),
    ...
    streaming: parseEnvVarBoolean(process.env.UNLEASH_EXPERIMENTAL_STREAMING, false),
    etagVariant: {
        name: 'disabled',
    ...
    edgeObservability: parseEnvVarBoolean(process.env.EXPERIMENTAL_EDGE_OBSERVABILITY, false),
    reportUnknownFlags: parseEnvVarBoolean(process.env.UNLEASH_EXPERIMENTAL_REPORT_UNKNOWN_FLAGS, false),
    lifecycleMetrics: parseEnvVarBoolean(process.env.UNLEASH_EXPERIMENTAL_LIFECYCLE_METRICS, false),
    createFlagDialogCache: parseEnvVarBoolean(process.env.UNLEASH_EXPERIMENTAL_CREATE_FLAG_DIALOG_CACHE, false),
    changeRequestApproverEmails: parseEnvVarBoolean(process.env.UNLEASH_EXPERIMENTAL_CHANGE_REQUEST_APPROVER_EMAILS, false),
    improvedJsonDiff: parseEnvVarBoolean(process.env.UNLEASH_EXPERIMENTAL_IMPROVED_JSON_DIFF, false),
    crDiffView: parseEnvVarBoolean(process.env.UNLEASH_EXPERIMENTAL_CR_DIFF_VIEW, false),
    impactMetrics: parseEnvVarBoolean(process.env.UNLEASH_EXPERIMENTAL_IMPACT_METRICS, false),
    eventGrouping: parseEnvVarBoolean(process.env.UNLEASH_EXPERIMENTAL_EVENT_GROUPING, false),
    paygTrialEvents: parseEnvVarBoolean(process.env.UNLEASH_EXPERIMENTAL_PAYG_TRIAL_EVENTS, false),
    paygInstanceStatsEvents: parseEnvVarBoolean(process.env.UNLEASH_EXPERIMENTAL_PAYG_INSTANCE_STATS_EVENTS, false),
    timestampsInChangeRequestTimeline: parseEnvVarBoolean(process.env.UNLEASH_EXPERIMENTAL_TIMESTAMPS_IN_CHANGE_REQUEST_TIMELINE, false),
    lifecycleGraphs: parseEnvVarBoolean(process.env.UNLEASH_EXPERIMENTAL_LIFECYCLE_GRAPHS, false),
    githubAuth: parseEnvVarBoolean(process.env.UNLEASH_EXPERIMENTAL_GITHUB_AUTH, false),
};
