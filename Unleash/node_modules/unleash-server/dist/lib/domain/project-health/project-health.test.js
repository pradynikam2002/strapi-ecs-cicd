...
import { calculateProjectHealth, calculateHealthRating, } from './project-health.js';
...
describe('calculateHealthRating', () => {
    ...
    it('works with stale and active feature flags', () => {
        ...
        expect(calculateHealthRating([{ stale: false }, { stale: true }, { stale: false }], exampleFeatureTypes)).toEqual(67);
    });
    it('counts potentially stale flags', () => {
        expect(calculateHealthRating([
