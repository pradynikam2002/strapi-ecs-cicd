...
export declare const clientFeaturesDeltaSchema: {
    readonly $id: "#/components/schemas/clientFeaturesDeltaSchema";
    readonly type: "object";
    readonly required: readonly ["events"];
    readonly description: "Schema for delta updates of feature configurations.";
    readonly properties: {
        readonly events: {
            readonly description: "A list of delta events.";
            readonly type: "array";
            readonly items: {
                readonly type: "object";
                readonly anyOf: readonly [{
                    readonly type: "object";
                    readonly required: readonly ["eventId", "type", "feature"];
                    readonly properties: {
                        readonly eventId: {
                        ...
                        readonly type: {
                            ...
                            readonly enum: readonly ["feature-updated"];
                        };
                        readonly feature: {
                    ...
                    readonly type: "object";
                    readonly required: readonly ["eventId", "type", "featureName", "project"];
                    readonly properties: {
                        readonly eventId: {
                            readonly type: "number";
                        };
                        readonly type: {
                            readonly type: "string";
                            readonly enum: readonly ["feature-removed"];
                        };
                    ...
                    readonly type: "object";
                    readonly required: readonly ["eventId", "type", "segment"];
                    readonly properties: {
                        readonly eventId: {
                            readonly type: "number";
                        };
                        readonly type: {
                            readonly type: "string";
                            readonly enum: readonly ["segment-updated"];
                        };
                        readonly segment: {
                    ...
                    readonly type: "object";
                    readonly required: readonly ["eventId", "type", "segmentId"];
                    readonly properties: {
                        readonly eventId: {
                            readonly type: "number";
                        };
                        readonly type: {
                            readonly type: "string";
                            readonly enum: readonly ["segment-removed"];
                        };
                        readonly segmentId: {
                            readonly type: "number";
                        };
                    ...
                    readonly type: "object";
                    readonly required: readonly ["type", "features", "segments", "eventId"];
                    readonly properties: {
                        readonly eventId: {
                            readonly type: "number";
                        };
                        readonly type: {
                            readonly type: "string";
                            readonly enum: readonly ["hydration"];
                        };
                        readonly features: {
                            readonly type: "array";
                            readonly items: {
...
export type ClientFeaturesDeltaSchema = FromSchema<typeof clientFeaturesDeltaSchema>;
//# sourceMappingURL=client-features-delta-schema.d.ts.map