...
export declare const featureEventsSchema: {
    ...
    readonly description: "One or more events happening to a specific feature flag";
    readonly properties: {
        readonly version: {
        ...
        readonly toggleName: {
            readonly description: "The name of the feature flag these events relate to";
            readonly type: "string";
            readonly example: "my.first.feature.flag";
        };
        readonly events: {
        ...
        readonly totalEvents: {
            readonly description: "How many events are there for this feature flag";
            readonly type: "integer";
            readonly minimum: 0;
            readonly example: 13;
        };
...
//# sourceMappingURL=feature-events-schema.d.ts.map