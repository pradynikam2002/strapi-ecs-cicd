...
export declare const featureVariantsSchema: {
    readonly $id: "#/components/schemas/featureVariantsSchema";
    readonly type: "object";
    readonly additionalProperties: false;
    readonly required: readonly ["version", "variants"];
    readonly description: "A versioned collection of feature flag variants.";
    readonly properties: {
        readonly version: {
            readonly type: "integer";
            readonly example: 1;
            readonly description: "The version of the feature variants schema.";
        };
        readonly variants: {
            readonly type: "array";
            readonly items: {
            ...
            readonly description: "All variants defined for a specific feature flag.";
        };
    };
    readonly components: {
        readonly schemas: {
...
//# sourceMappingURL=feature-variants-schema.d.ts.map