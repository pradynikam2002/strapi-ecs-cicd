...
export declare const advancedPlaygroundResponseSchema: {
    readonly $id: "#/components/schemas/advancedPlaygroundResponseSchema";
    ...
    readonly properties: {
        readonly input: {
            ...
            readonly $ref: "#/components/schemas/advancedPlaygroundRequestSchema";
        };
        readonly features: {
            readonly type: "array";
            readonly description: "The list of features that have been evaluated.";
            readonly items: {
                readonly $ref: "#/components/schemas/advancedPlaygroundFeatureSchema";
            };
        };
        readonly warnings: {
            readonly type: "object";
            readonly description: "Warnings that occurred during evaluation.";
            readonly properties: {
                readonly invalidContextProperties: {
                    readonly type: "array";
                    readonly description: "A list of top-level context properties that were provided as input that are not valid due to being the wrong type.";
                    readonly items: {
    ...
    readonly components: {
        readonly schemas: {
            ...
            readonly advancedPlaygroundFeatureSchema: {
                readonly $id: "#/components/schemas/advancedPlaygroundFeatureSchema";
                readonly description: "A simplified feature flag model intended for the Unleash playground.";
                readonly type: "object";
                readonly additionalProperties: false;
                readonly required: readonly ["name", "projectId", "environments"];
                readonly properties: {
                    readonly name: {
                        readonly type: "string";
                    ...
                    readonly environments: {
                        readonly type: "object";
                        readonly description: "The lists of features that have been evaluated grouped by environment.";
                        readonly additionalProperties: {
                            readonly type: "array";
                            readonly items: {
                                readonly $ref: "#/components/schemas/advancedPlaygroundEnvironmentFeatureSchema";
                            };
                        };
                    };
                };
                readonly components: {
                    readonly schemas: {
                        readonly advancedPlaygroundEnvironmentFeatureSchema: {
                            readonly $id: "#/components/schemas/advancedPlaygroundEnvironmentFeatureSchema";
                            readonly description: "A simplified feature flag model intended for the Unleash playground.";
                            readonly type: "object";
                            readonly additionalProperties: false;
                            readonly required: readonly ["name", "environment", "context", "projectId", "isEnabled", "isEnabledInCurrentEnvironment", "variant", "variants", "strategies"];
                            readonly properties: {
                                readonly name: {
                                    readonly type: "string";
                                    readonly example: "my-feature";
                                ...
                                readonly environment: {
                                    ...
                                    readonly description: "The feature's environment.";
                                };
                                readonly context: {
                                    readonly description: "The context to use when evaluating flags";
                                ...
                                readonly strategies: {
                                    ...
                                    readonly description: "Feature's applicable strategies and cumulative results of the strategies";
                                    readonly properties: {
                                        readonly result: {
                                ...
                                readonly variant: {
                                    ...
                                    readonly properties: {
                                        ...
                                        readonly feature_enabled: {
                                            readonly type: "boolean";
                                            readonly description: "Whether the feature is enabled or not. If the feature is disabled, this property will be `false`";
                                        };
                                    };
            ...
            readonly advancedPlaygroundRequestSchema: {
