...
export declare const frontendApiFeaturesPostSchema: {
    readonly $id: "#/components/schemas/frontendApiFeaturesPostContextSchema";
    readonly description: "The Unleash frontend API POST request body.";
    readonly type: "object";
    readonly additionalProperties: true;
    readonly properties: {
        readonly context: {
            readonly description: "The Unleash context.";
            readonly type: "object";
            readonly additionalProperties: true;
            readonly properties: {
                readonly appName: {
...
export type FrontendApiFeaturesPostSchema = FromSchema<typeof frontendApiFeaturesPostSchema>;
//# sourceMappingURL=frontend-api-features-post-schema.d.ts.map