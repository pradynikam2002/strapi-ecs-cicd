...
export declare const createFeatureStrategySchema: {
...
export type CreateFeatureStrategySchema = FromSchema<typeof createFeatureStrategySchema>;
//# sourceMappingURL=create-feature-strategy-schema.d.ts.map