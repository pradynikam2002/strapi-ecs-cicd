...
export declare const eventSearchResponseSchema: {
    readonly $id: "#/components/schemas/eventsSearchResponseSchema";
    readonly type: "object";
    readonly additionalProperties: false;
    readonly required: readonly ["events", "total"];
    readonly description: "A list of events that have been registered by the system";
    readonly properties: {
        readonly events: {
        ...
        readonly total: {
            ...
            readonly description: "The total count of events";
            readonly minimum: 0;
            readonly example: 842;
        };
    };
    readonly components: {
        readonly schemas: {
...
export type EventSearchResponseSchema = FromSchema<typeof eventSearchResponseSchema>;
//# sourceMappingURL=event-search-response-schema.d.ts.map