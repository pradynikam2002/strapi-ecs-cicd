...
export declare const integrationEventsSchema: {
    readonly $id: "#/components/schemas/integrationEventsSchema";
    readonly description: "A response model with a list of integration events.";
    readonly type: "object";
    readonly additionalProperties: false;
    readonly required: readonly ["integrationEvents"];
    readonly properties: {
        readonly integrationEvents: {
            readonly type: "array";
            readonly description: "A list of integration events.";
            readonly items: {
                readonly $ref: "#/components/schemas/integrationEventSchema";
            };
        };
    };
    readonly components: {
        readonly schemas: {
            readonly integrationEventSchema: {
                readonly $id: "#/components/schemas/integrationEventSchema";
                readonly type: "object";
                readonly required: readonly ["id", "integrationId", "createdAt", "state", "stateDetails", "event", "details"];
                readonly description: "An object describing an integration event.";
                readonly additionalProperties: false;
                readonly properties: {
                    readonly id: {
                        readonly type: "string";
                        readonly pattern: "^[0-9]+$";
                        readonly description: "The integration event's ID. Integration event IDs are incrementing integers. In other words, a more recently created integration event will always have a higher ID than an older one. This ID is represented as a string since it is a BigInt.";
                        readonly example: "7";
                    };
                    readonly integrationId: {
                        readonly type: "integer";
                        readonly description: "The ID of the integration that the integration event belongs to.";
                        readonly example: 42;
                    };
                    readonly createdAt: {
                        readonly type: "string";
                        readonly format: "date-time";
                        readonly description: "The date and time of when the integration event was created. In other words, the date and time of when the integration handled the event.";
                        readonly example: "2023-12-27T13:37:00+01:00";
                    };
                    readonly state: {
                        readonly type: "string";
                        readonly enum: readonly ["success", "failed", "successWithErrors"];
                        readonly description: "The state of the integration event. Can be one of `success`, `failed` or `successWithErrors`.";
                        readonly example: "failed";
                    };
                    readonly stateDetails: {
                        readonly type: "string";
                        readonly description: "Details about the state of the integration event.";
                        readonly example: "Status code: 429 - Rate limit reached.";
                    };
                    readonly event: {
                        readonly $ref: "#/components/schemas/eventSchema";
                        readonly description: "The event that triggered this integration event.";
                    };
                    readonly details: {
                        readonly type: "object";
                        readonly 'x-enforcer-exception-skip-codes': "WSCH006";
                        readonly description: "Detailed information about the integration event. The contents vary depending on the type of integration and the specific details.";
                        readonly example: {
                            readonly message: "*user@yourcompany.com* created a new *slack-app* integration configuration";
                            readonly channels: readonly ["engineering", "unleash-updates"];
                        };
                    };
                };
                readonly components: {
...
//# sourceMappingURL=integration-events-schema.d.ts.map