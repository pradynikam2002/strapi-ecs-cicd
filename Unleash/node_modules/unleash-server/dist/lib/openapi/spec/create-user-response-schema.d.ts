...
export declare const createUserResponseSchema: {
    readonly $id: "#/components/schemas/createUserResponseSchema";
    readonly type: "object";
    readonly additionalProperties: false;
    readonly description: "An Unleash user after creation";
    readonly required: readonly ["id"];
    readonly properties: {
        readonly rootRole: {
            readonly description: "Which [root role](https://docs.getunleash.io/reference/rbac#predefined-roles) this user is assigned. Usually a numeric role ID, but can be a string when returning newly created user with an explicit string role.";
...
//# sourceMappingURL=create-user-response-schema.d.ts.map