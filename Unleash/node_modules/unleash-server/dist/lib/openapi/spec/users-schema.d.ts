...
export declare const usersSchema: {
    ...
    readonly properties: {
        ...
        readonly rootRoles: {
            readonly type: "array";
            readonly description: "A list of [root roles](https://docs.getunleash.io/reference/rbac#predefined-roles) in the Unleash instance.";
            readonly items: {
