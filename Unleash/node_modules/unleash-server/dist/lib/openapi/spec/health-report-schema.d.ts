...
export declare const healthReportSchema: {
    readonly $id: "#/components/schemas/healthReportSchema";
    readonly description: "A report of the current health of the requested project, with datapoints like counters of currently active, stale, and potentially stale feature flags.";
    readonly required: readonly ["version", "name", "defaultStickiness", "mode", "members", "health", "technicalDebt", "environments", "features", "potentiallyStaleCount", "activeCount", "staleCount"];
    readonly properties: {
...
//# sourceMappingURL=health-report-schema.d.ts.map