...
exports.up = function (db, cb) {
    ...
    db.runSql(`INSERT INTO settings(name, content) VALUES ('login_history_retention', '{"hours": 336}')`, cb);
};
exports.down = function (db, cb) {
    db.runSql(`ALTER TABLE login_history RENAME TO sign_on_log`, cb);
    db.runSql(`DELETE FROM settings WHERE name = 'login_history_retention'`, cb);
    db.runSql(`INSERT INTO settings(name, content) VALUES ('sign_on_log_retention', '{"hours": 336}')`, cb);
};
//# sourceMappingURL=20230302133740-rename-sign-on-log-table-to-login-history.js.map