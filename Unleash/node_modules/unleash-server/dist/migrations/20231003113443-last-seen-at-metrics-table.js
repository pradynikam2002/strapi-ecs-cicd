...
exports.up = function (db, callback) {
    db.runSql(`
      ...
      ON last_seen_at_metrics (feature_name);`, callback());
};
exports.down = function (db, callback) {
    db.runSql(`DROP TABLE last_seen_at_metrics;
      `, callback());
};
//# sourceMappingURL=20231003113443-last-seen-at-metrics-table.js.map