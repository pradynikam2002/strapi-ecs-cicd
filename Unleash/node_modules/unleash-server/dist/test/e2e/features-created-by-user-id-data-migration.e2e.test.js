import { createEventsService, createFeatureToggleService, } from '../../lib/features/index.js';
import { FEATURES_CREATED_BY_PROCESSED } from '../../lib/metric-events.js';
import { ADMIN_TOKEN_USER, } from '../../lib/types/index.js';
...
beforeAll(async () => {
    ...
    db = await dbInit('features_created_by_user_id_migration', config.getLogger);
...
//# sourceMappingURL=features-created-by-user-id-data-migration.e2e.test.js.map